...
'''
Sequential stitching videos
================

Stitch videos sequentially from given files.
No threads are implemented in this script so reading the, stitching and display/saving
