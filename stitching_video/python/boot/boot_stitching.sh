...
python3 $STREAM_STITCHING --capture_width 3840 --capture_height 2160 --interface usb --device0 2 --device1 4
elif [ $1 == "low" ]
then
echo 'Resolution set to LOW : 640x480'
python3 $STREAM_STITCHING --capture_width 640 --capture_height 480 --interface usb --device0 2 --device1 4
fi